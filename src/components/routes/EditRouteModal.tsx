...
const EditRouteModal: React.FC<EditRouteModalProps> = ({ route, onClose, onRouteUpdated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      customToast.success('Route updated successfully');
      onRouteUpdated();
      onClose();
    } catch (error) {
      customToast.error('Failed to update route');
    } finally {
      setLoading(false);
    }
  };
